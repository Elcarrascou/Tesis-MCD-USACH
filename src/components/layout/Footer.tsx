...
export default function Footer() {
  return (
    <footer className="relative z-10" style={{ background: '#112624', borderTop: '1px solid rgba(0,154,147,0.12)' }}>
      <div className="max-w-5xl mx-auto px-9 py-8 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          <UsachShieldSm />
          <div>
            <p className="font-sans text-[12px] font-bold tracking-[0.1em] uppercase text-u-gold leading-none mb-0.5">USACH</p>
