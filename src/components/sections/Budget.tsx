...
export default function Budget() {
  return (
    <section id="budget" className="py-24" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
      <div className="max-w-5xl mx-auto px-9">
        ...
        <div className="rounded-[14px] px-7 py-6 flex flex-wrap justify-between items-center gap-5"
          style={{ background: 'rgba(232,164,0,0.05)', border: '1px solid rgba(232,164,0,0.2)' }}>
          <div>
            <div className="font-mono text-[12px] text-u-muted mb-1">Costo mensual estimado</div>
            <div className="font-cond text-[44px] font-bold text-u-gold leading-none">~$136 USD</div>
          </div>
          <div className="text-right">
            <div className="font-mono text-[12px] text-u-muted mb-1">Presupuesto total (2 meses)</div>
            <div className="font-cond text-[44px] font-bold text-u-white leading-none">~$272 USD</div>
          </div>
        </div>
