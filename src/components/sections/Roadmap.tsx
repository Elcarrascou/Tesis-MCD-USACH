const phases = [
  ...
  {
    phase: 'Fase 3',
    title: 'Integración del Agente IA',
  ...
  {
    phase: 'Fase 6',
    title: 'Documentación & Presentación MCD',
...
export default function Roadmap() {
  return (
    <section id="roadmap" className="py-24" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
      <div className="max-w-5xl mx-auto px-9">
        ...
        <div className="relative pl-5">
          {/* Vertical line */}
          <div className="absolute left-[5px] top-2 bottom-2 w-px" style={{ background: 'rgba(255,255,255,0.11)' }} />
          ...
          {phases.map((p) => (
            <div key={p.phase} className="relative pl-6 pb-8 last:pb-0">
              ...
              <div className="absolute left-[-17px] top-1 w-3 h-3 rounded-full border-2"
                style={{ borderColor: p.color, background: '#101929' }} />
